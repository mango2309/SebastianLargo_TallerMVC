...
namespace SebastianLargo_TallerMVC.Controllers
{
    public class BurguersController : Controller
    {
        private readonly SebastianLargo_TallerMVCContext _context;

        public BurguersController(SebastianLargo_TallerMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,BurgerID,Name,WithCheese,Precio,Salad1,Salad12")] Burguer burguer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,BurgerID,Name,WithCheese,Precio,Salad1,Salad12")] Burguer burguer)
        {
            if (id != burguer.Id)
            {
                return NotFound();
